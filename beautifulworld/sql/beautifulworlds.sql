...
colum_description varchar(1023) comment "コラム文章",
staff_id int not null comment "スタッフID",
image_file_path varchar(100) comment "画像ファイルパス",
image_file_name varchar(50) comment "画像ファイル名",
update_date datetime comment "更新日"
...
ご飯も美味しいので是非行ってみて下さい(^^)"
,2,"./images","colum2.jpeg","2019-04-02"),
(3,3,"silver",
"こんにちは！
最近のオススメの雑誌を紹介いたします！！
...
(5,5,"春、おススメピンクカラー！",
"こんにちは！
今回もアシスタントのandreyちゃんから
カラーをお願いされたのでいい感じにしました！
ベースは前回のピンクが落ちてベージュに。。
今回は前よりは落ち着き過ぎない明るめとのオーダー
なので、ビビッとな単色は使わないで
元々、調合されてるカラー剤を使いました！

11ピンクベージュ：11グレージュを2:1
コントロールカラーのピンクハイを4%程入れました
根元が伸びてきたので栄え目がハッキリしないように
気持ち根元を溜めて温度を上げて若干ですが
根元濃いめ、毛先うっすらと色が乗るイメージに
なるようにしてみました！

自然光で撮る事が出来なかったので
色は分かりずらいですが、、、可愛くなりました！"
,1,"./images","colum5.jpg","2019-03-26"),
(6,6,"春っぽベージュ",
"今回はブリーチ毛のモデルさんを、
春っぽいベージュのカラーにしました！
...
紫の感じも少し春っぽい感じが出ててすごくいいですね！！
"
,3,"./images","colum6.jpg","2019-03-21"),
(7,7,"トーンダウン",
"こんにちは！

よくカラーのモデル様で何回か来て頂ける方がいてずっとトーンアップだったのですが
４月から社会人ということでトーンダウンしました！
真っ黒ではなくていいらしいので黒ではないけどしっかり透け感も出しつつ色が落ちても綺麗な色落ちにしたいので
しっかり赤みを消すカラー剤をいれました！

私も去年の４月を思い出しますがとてもこの季節はドキドキしますね、、"
,3,"./images","colum7.jpg","2019-03-31"),
(8,8,"ミディアムボブ",
"春に向けて動きのあるスタイルがオススメです！

ワンカールももちろん可愛いですがレイヤーを入れて動きが出るボブも可愛いです！


カラーもベージュ系や薄いアッシュ系がおすすめです！

こちらのお客様は11トーンのアッシュパールと11トーンのミントアッシュを少し入れて染めました！

赤みが苦手な方が多いのでミントアッシュなどで赤みを消しつつもアッシュは出るように

考えてるので綺麗な色味になりますよ☆


巻き方などわからないことがあればスタッフまでお気軽にどうぞ☆"
,6,"./images","colum8.jpg","2019-03-28"),
(9,9,"	iNOA カラー",
"日本初上陸！オイルで染めるイノアカラー！
従来のカラー剤とは全く別物！
...
アルカリ剤の役割を減らす、アルカリ剤に量を減らす

２、オイルグロスの発色
奥深さ×透明感×グロス感

日本人の女性が好む色　赤み、黄ばみの徹底した抑制
...
ファションカラーなのにグレーまで染まる
豊富なカラーバリエーション！
ファションからグレーカラーに変えるのには
抵抗がある！カラーバリエーションも減ってしまう
心配全くありません！
そして、ダメージレスでカラーも楽しめちゃう！

カラー料金に+1500（税抜）"
,1,"./images","colum9.jpg","2019-04-01");
